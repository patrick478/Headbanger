 ...
 * provided by the Facebook mddn.swen.headbanger.application, in order to handle processing of the mddn.swen.headbanger.activity
...
public class UiLifecycleHelper {
    ...
    private final static String ACTIVITY_NULL_MESSAGE = "mddn.swen.headbanger.activity cannot be null";
    ...
    /**
     * Register that we are expecting results from a call to the Facebook mddn.swen.headbanger.application (e.g., from a native
