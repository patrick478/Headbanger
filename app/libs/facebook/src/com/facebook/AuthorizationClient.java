...
class AuthorizationClient implements Serializable {
    ...
    void setContext(final Context context) {
        ...
        // We rely on individual requests to tell us how to start an mddn.swen.headbanger.activity.
    ...
    void setContext(final Activity activity) {
        ...
        // If we are used in the context of an mddn.swen.headbanger.activity, we will always use that mddn.swen.headbanger.activity to
