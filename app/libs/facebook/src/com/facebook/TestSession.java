 ...
 * mddn.swen.headbanger.application. This should never be used from a real mddn.swen.headbanger.application, but may be useful
 ...
 * production mddn.swen.headbanger.application code.
 * <p/>
 ...
 * mddn.swen.headbanger.application ID and mddn.swen.headbanger.application Secret to be used for managing test users. These methods are
...
public class TestSession extends Session {
     ...
     * close; This method should not be used in mddn.swen.headbanger.application code -- but is useful for creating unit tests
     ...
     * tests).
     * <p/>
     * This method should not be used in mddn.swen.headbanger.application code -- but is useful for creating unit tests
     * that use the Facebook SDK.
     *
     * @param activity    the Activity to use for opening the session
     * @param permissions list of strings containing permissions to request; nil will result in
    ...
    /**
     * Gets the Facebook Application ID for the mddn.swen.headbanger.application under test.
     *
     * @return the mddn.swen.headbanger.application ID
     */
    ...
    /**
     * Sets the Facebook Application ID for the mddn.swen.headbanger.application under test. This must be specified
     * prior to creating a TestSession.
     *
     * @param applicationId the mddn.swen.headbanger.application ID
     */
    public static synchronized void setTestApplicationId(String applicationId) {
        if (testApplicationId != null && !testApplicationId.equals(applicationId)) {
            throw new FacebookException("Can't have more than one test mddn.swen.headbanger.application ID");
        }
        testApplicationId = applicationId;
    }

    /**
     * Gets the Facebook Application Secret for the mddn.swen.headbanger.application under test.
     *
     * @return the mddn.swen.headbanger.application secret
     */
    ...
    /**
     * Sets the Facebook Application Secret for the mddn.swen.headbanger.application under test. This must be specified
     * prior to creating a TestSession.
     *
     * @param applicationSecret the mddn.swen.headbanger.application secret
     */
    public static synchronized void setTestApplicationSecret(String applicationSecret) {
        if (testApplicationSecret != null && !testApplicationSecret.equals(applicationSecret)) {
            throw new FacebookException("Can't have more than one test mddn.swen.headbanger.application secret");
        }
