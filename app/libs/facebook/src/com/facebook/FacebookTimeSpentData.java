...
class FacebookTimeSpentData implements Serializable {
    ...
    void onResume(AppEventsLogger logger, long eventTime, String sourceApplicationInfo) {
        ...
        // If this is an mddn.swen.headbanger.application that's not calling onSuspend yet, log and return. We can't
        // track time spent for this mddn.swen.headbanger.application as there are no calls to onSuspend.
        if (isAppActive) {
        ...
        // Set source mddn.swen.headbanger.application only for the first resume of the timespent session.
