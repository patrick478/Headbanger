...
public final class Settings {
    ...
    /**
     * loadDefaultsFromMetadata will attempt to load certain settings (e.g., mddn.swen.headbanger.application ID, client token) from
     * metadata in the app's AndroidManifest.xml. The mddn.swen.headbanger.application ID will be read from this key.
     */
    ...
    /**
     * Initialize SDK
     * This function will be called once in the mddn.swen.headbanger.application, it is tried to be called as early as possible;
    ...
    static void publishInstallAsync(final Context context, final String applicationId,
        ...
        // grab the mddn.swen.headbanger.application context ahead of time, since we will return to the caller immediately.
    ...
    /**
     * Gets the mddn.swen.headbanger.application version to the provided string.
     * @return mddn.swen.headbanger.application version set via setAppVersion.
     */
    ...
    /**
     * Sets the mddn.swen.headbanger.application version to the provided string.  AppEventsLogger.logEvent calls logs its event with the
    ...
    /**
     * Loads default values for certain settings from an mddn.swen.headbanger.application's AndroidManifest.xml metadata, if possible.
    ...
    /**
     * Gets the Facebook mddn.swen.headbanger.application ID for the current app. This will be null unless explicitly set or unless
    ...
    /**
     * Sets the Facebook mddn.swen.headbanger.application ID for the current app.
