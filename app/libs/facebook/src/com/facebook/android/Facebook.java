...
public class Facebook {
     ...
     * 
     * @param appId
     *            Your Facebook mddn.swen.headbanger.application ID. Found at
     *            www.facebook.com/developers/apps.php.
     */
    @Deprecated
    public Facebook(String appId) {
        if (appId == null) {
            throw new IllegalArgumentException("You must specify your mddn.swen.headbanger.application ID when instantiating "
     ...
     * Facebook and grant the requested permissions to the given mddn.swen.headbanger.application.
     * <p/>
     ...
     * the Facebook for Android stand-alone mddn.swen.headbanger.application, which will handle the
     ...
     * by Facebook in an embedded WebView, not by the client mddn.swen.headbanger.application. As
     ...
     *
     * @param activity
     *            The Android mddn.swen.headbanger.activity in which we want to display the
     *            authorization dialog.
     * @param permissions
     *            A list of permissions required for this mddn.swen.headbanger.application: e.g.
     *            "read_stream", "publish_stream", "offline_access", etc. see
     *            http://developers.facebook.com/docs/authentication/permissions
     *            This parameter should not be null -- if you do not require any
     *            permissions, then pass in an empty String array.
     * @param activityCode
     *            Single sign-on requires an mddn.swen.headbanger.activity result to be called back
     *            to the client mddn.swen.headbanger.application -- if you are waiting on other
     *            activities to return data, pass a custom mddn.swen.headbanger.activity code here to
     ...
     * @param listener
     *            Callback interface for notifying the calling mddn.swen.headbanger.application when
    ...
    /**
     * Query the signature for the mddn.swen.headbanger.application that would be invoked by the
     * given intent and verify that it matches the FB mddn.swen.headbanger.application's signature.
     * 
     * @param context
     * @param packageName
     ...
     * mddn.swen.headbanger.activity's onActivityResult() function or Facebook authentication will
     * not function properly!
     * <p/>
     * If your calling mddn.swen.headbanger.activity does not currently implement onActivityResult(),
     ...
     * stand-alone mddn.swen.headbanger.application mddn.swen.headbanger.application to refresh the access token. This
    ...
    public boolean extendAccessToken(Context context, ServiceListener serviceListener) {
        ...
        // Verify that the mddn.swen.headbanger.application whose package name is
        // com.facebook.katana
     ...
     *            "stream.publish", ...
     * @param listener
     *            Callback interface to notify the mddn.swen.headbanger.application when the dialog
     *            has completed.
     */
    @Deprecated
     ...
     * This method is deprecated.  See {@link Facebook} and {@link Session} for more info.
     *
     * @return the String representing mddn.swen.headbanger.application ID
     */
    @Deprecated
     ...
     * This method is deprecated.  See {@link Facebook} and {@link Session} for more info.
     *
     * @param appId the String representing the mddn.swen.headbanger.application ID
     */
    @Deprecated
     ...
     * it has occurred previously or the app does not have install attribution enabled on the mddn.swen.headbanger.application's developer
     * config page.
     * <p/>
     * This method is deprecated.  See {@link Facebook} and {@link Settings} for more info.
     *
