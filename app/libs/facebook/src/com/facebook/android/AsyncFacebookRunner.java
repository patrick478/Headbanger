 ...
 * a specific mddn.swen.headbanger.application's needs.
 *
 * @deprecated
 *
 * @see RequestListener
...
public class AsyncFacebookRunner {
     ...
     * through the API. The mddn.swen.headbanger.application will be notified when logout is
     ...
     * @param listener
     *            Callback interface to notify the mddn.swen.headbanger.application when the request
     *            has completed.
     * @param state
