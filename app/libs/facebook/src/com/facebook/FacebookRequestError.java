...
public final class FacebookRequestError {
    ...
    /**
     * Returns the resource id for a user-friendly message for the mddn.swen.headbanger.application to
     * present to the user.
     *
    ...
    public enum Category {
        ...
        /**
         * Indicates that the error is an mddn.swen.headbanger.application error resulting in a bad or malformed
