 ...
 *
 * <p>Note that this ContentProvider is only necessary if an mddn.swen.headbanger.application wishes to attach images, etc., that are
 ...
 * necessary.</p>
 *
 * <p>If an mddn.swen.headbanger.application wishes to attach images that are stored in-memory within the mddn.swen.headbanger.application, this content
 * provider must be listed in the mddn.swen.headbanger.application's AndroidManifest.xml, and it should be named according to the
...
public class NativeAppCallContentProvider extends ContentProvider {
     ...
     * @param applicationId the Facebook mddn.swen.headbanger.application ID of the mddn.swen.headbanger.application
