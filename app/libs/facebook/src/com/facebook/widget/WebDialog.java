...
public class WebDialog extends Dialog {
    ...
    public static class Builder extends BuilderBase<Builder> {
        /**
         * Constructor that builds a dialog using either the active session, or the mddn.swen.headbanger.application
         * id specified in the mddn.swen.headbanger.application/meta-data.
         *
         ...
         *
         * @param context the Context within which the dialog will be shown.
         * @param applicationId the mddn.swen.headbanger.application ID to be included in the dialog URL.
         * @param action the portion of the dialog URL following www.facebook.com/dialog/.
         *               See https://developers.facebook.com/docs/reference/dialogs/ for details.
         * @param parameters a Bundle containing parameters to pass as part of the URL.
         */
    ...
    public static class FeedDialogBuilder extends BuilderBase<FeedDialogBuilder> {
        ...
        /**
         * Constructor that builds a Feed Dialog using either the active session, or the mddn.swen.headbanger.application
         * ID specified in the mddn.swen.headbanger.application/meta-data.
         *
         * @param context the Context within which the dialog will be shown.
         */
        ...
        /**
         * Constructor that builds a Feed Dialog using the provided mddn.swen.headbanger.application ID and parameters.
         *
         * @param context       the Context within which the dialog will be shown.
         * @param applicationId the mddn.swen.headbanger.application ID to use. If null, the mddn.swen.headbanger.application ID specified in the
         *                      mddn.swen.headbanger.application/meta-data will be used instead.
         * @param parameters    a Bundle containing parameters to pass as part of the
         *                      dialog URL. No validation is done on these parameters; it is
         *                      the caller's responsibility to ensure they are valid. For more information,
         *                      see <a href="https://developers.facebook.com/docs/reference/dialogs/feed/">
    ...
    public static class RequestsDialogBuilder extends BuilderBase<RequestsDialogBuilder> {
        ...
        /**
         * Constructor that builds a Requests Dialog using either the active session, or the mddn.swen.headbanger.application
         * ID specified in the mddn.swen.headbanger.application/meta-data.
         *
         * @param context the Context within which the dialog will be shown.
         */
        ...
        /**
         * Constructor that builds a Requests Dialog using the provided mddn.swen.headbanger.application ID and parameters.
         *
         * @param context       the Context within which the dialog will be shown.
         * @param applicationId the mddn.swen.headbanger.application ID to use. If null, the mddn.swen.headbanger.application ID specified in the
         *                      mddn.swen.headbanger.application/meta-data will be used instead.
