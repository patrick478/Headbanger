...
class FacebookFragment extends Fragment {
    ...
    /**
     * Called when the mddn.swen.headbanger.activity that was launched exits. This method manages session
    ...
    /**
     * Opens a new session. This method will use the mddn.swen.headbanger.application id from
     ...
     * @param activityCode the mddn.swen.headbanger.activity code to use for the SSO mddn.swen.headbanger.activity
     */
    protected final void openSessionForRead(String applicationId, List<String> permissions,
