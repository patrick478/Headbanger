...
public class LikeView extends FrameLayout {
    ...
    /**
     * If your app does not use UiLifeCycleHelper, then you must call this method in the calling mddn.swen.headbanger.activity's
     * onActivityResult method, to process any pending like actions, where tapping the button had resulted in
     * the Like dialog being shown in the Facebook mddn.swen.headbanger.application.
     *
