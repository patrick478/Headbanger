...
/*
 * Provides an interface for presenting dialogs provided by the Facebook mddn.swen.headbanger.application for Android. This class
 * provides builders that present a strongly-typed interface to generate properly-formed Intents for launching
 * the appropriate Activities provided by the Facebook mddn.swen.headbanger.application.
 */
public class FacebookDialog {
    ...
    public interface Callback {
         ...
         * @param data        the full set of extras associated with the mddn.swen.headbanger.activity result
         */
    ...
    /**
     * Defines a set of features that may be supported by the native Share dialog exposed by the Facebook mddn.swen.headbanger.application.
     ...
     * to determine whether the version of the Facebook mddn.swen.headbanger.application installed on the user's device is recent
    ...
    public enum ShareDialogFeature implements DialogFeature {
         ...
         * Facebook mddn.swen.headbanger.application.
         */
    ...
    /**
     * Defines a set of features that may be supported by the native Message dialog exposed by the Facebook Messenger mddn.swen.headbanger.application.
     * As additional features are added, these flags may be passed to
     ...
     * mddn.swen.headbanger.application. As additional features are added, these flags may be passed to
    ...
    public enum OpenGraphMessageDialogFeature implements DialogFeature {
         ...
         * Messenger mddn.swen.headbanger.application.
         */
    ...
    /**
     * Launches an mddn.swen.headbanger.activity in the Facebook mddn.swen.headbanger.application to present the desired dialog. This method returns a
     * PendingCall that contains a unique ID associated with this call to the Facebook mddn.swen.headbanger.application. In general,
     * a calling Activity should use UiLifecycleHelper to handle incoming mddn.swen.headbanger.activity results, in order to ensure
     * proper processing of the results from this dialog.
     *
     * @return a PendingCall containing the unique call ID corresponding to this call to the Facebook mddn.swen.headbanger.application
     */
    ...
    /**
     * Parses the results of a dialog mddn.swen.headbanger.activity and calls the appropriate method on the provided Callback.
     *
     * @param context     the Context that is handling the mddn.swen.headbanger.activity result
     * @param appCall     an PendingCall containing the call ID and original Intent used to launch the dialog
     * @param requestCode the request code for the mddn.swen.headbanger.activity result
     * @param data        the result Intent
     * @param callback    a callback to call after parsing the results
     * @return true if the mddn.swen.headbanger.activity result was handled, false if not
     */
    ...
    /**
     * Determines whether the version of the Facebook mddn.swen.headbanger.application installed on the user's device is recent
     ...
     *         Facebook mddn.swen.headbanger.application; false if any of the features are not supported
     */
    ...
    public abstract static class Builder<CONCRETE extends Builder<?>> {
        ...
        public Builder(Activity activity) {
            Validate.notNull(activity, "mddn/swen/headbanger/activity");
        ...
        /**
         * Sets the request code that will be passed to handleActivityResult when this mddn.swen.headbanger.activity completes; the
        ...
        /**
         * Sets the name of the mddn.swen.headbanger.application to be displayed in the dialog. If provided, this optimizes the user
         * experience as a preview of a shared item, etc., can be displayed sooner.
         *
         * @param applicationName the name of the Facebook mddn.swen.headbanger.application
         * @return this instance of the builder
         */
         ...
         * the Facebook mddn.swen.headbanger.application.
         *
         ...
         * Facebook mddn.swen.headbanger.application is installed on the device, and whether the installed version supports all of
     ...
     * Share dialog. This builder will throw an exception if the Facebook mddn.swen.headbanger.application is not installed, so it
    ...
    private static abstract class PhotoDialogBuilderBase<CONCRETE extends PhotoDialogBuilderBase<?>>
         ...
         * <p>In order for the images to be provided to the Facebook mddn.swen.headbanger.application as part of the app call, the
         * NativeAppCallContentProvider must be specified correctly in the mddn.swen.headbanger.application's AndroidManifest.xml.</p>
    ...
    /**
     * Provides a builder which can construct a FacebookDialog instance suitable for presenting the native
     * Share dialog for sharing photos. This builder will throw an exception if the Facebook mddn.swen.headbanger.application is not
    ...
    /**
     * Provides a builder which can construct a FacebookDialog instance suitable for presenting the native
     * Message dialog for sharing photos. This builder will throw an exception if the Messenger mddn.swen.headbanger.application is not
    ...
    /**
     * Provides a builder which can construct a FacebookDialog instance suitable for presenting the native
     * Message dialog. This builder will throw an exception if the Facebook Messenger mddn.swen.headbanger.application is not installed, so it
        ...
        public OpenGraphDialogBuilderBase(Activity activity, OpenGraphAction action, String actionType,
            ...
            if (!Utility.isNullOrEmpty(typeOnAction) && !typeOnAction.equals(actionType)) {
                throw new IllegalArgumentException("'actionType' must match the type of 'action' if it is specified. " +
                        "Consider using OpenGraphDialogBuilderBase(Activity mddn.swen.headbanger.activity, OpenGraphAction action, " +
     ...
     * This builder will throw an exception if the Facebook mddn.swen.headbanger.application is not installed, so it
    ...
    /**
     * Encapsulates information about a call being made to the Facebook mddn.swen.headbanger.application for Android. A unique String
    ...
    public static class PendingCall implements Parcelable {
        ...
        /**
         * Returns the Intent that was used to initiate this call to the Facebook mddn.swen.headbanger.application.
         *
         * @return the Intent
         */
        ...
        /**
         * Returns the unique ID of this call to the Facebook mddn.swen.headbanger.application.
         *
