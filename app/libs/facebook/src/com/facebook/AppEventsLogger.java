 ...
 * <ul>
 * <li>
 * Logging predefined and mddn.swen.headbanger.application-defined events to Facebook App Insights with a
...
public class AppEventsLogger {
    ...
    // mddn.swen.headbanger.application ID and access token (which may be null for Session-less calls). This avoids needing to
     ...
     *
     * Use this method if your mddn.swen.headbanger.application ID is stored in mddn.swen.headbanger.application metadata, otherwise see
    ...
    public static void activateApp(Context context, String applicationId) {
        ...
        if ((context instanceof Activity)) {
          ...
          // If context is not an Activity, we cannot get intent nor calling mddn.swen.headbanger.activity.
          resetSourceApplication();
          Log.d(AppEventsLogger.class.getName(),
              "To set source mddn.swen.headbanger.application the context of activateApp must be an instance of Activity");
        }
     ...
     * tracks the mddn.swen.headbanger.application session information. Should be called whenever your app becomes
     ...
     * comes from this mddn.swen.headbanger.application's metadata. The mddn.swen.headbanger.application ID used to log events will be determined from
    ...
    /**
     * Build an AppEventsLogger instance to log events that are attributed to the mddn.swen.headbanger.application but not to
    ...
    private static void setSourceApplication(Activity activity) {
        ...
        // Tap icon to open an app will still get the old intent if the mddn.swen.headbanger.activity was opened by an intent before.
