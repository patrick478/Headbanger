...
public interface OpenGraphObject extends GraphObject {
    ...
    /**
     * Gets the mddn.swen.headbanger.application that created this object.
     * @return the mddn.swen.headbanger.application
     */
    GraphObject getApplication();

    /**
     * Sets the mddn.swen.headbanger.application that created this object.
     * @param application the mddn.swen.headbanger.application
     */
     ...
     * mddn.swen.headbanger.application-defined Open Graph object type will appear here.
